...
BASE_DATA = r"C:\jupyter\juan\IL2\dataset\esm2\max_35\0.5_rag_fused"
OUTPUT_DIR = "multiseed_results"
os.makedirs(OUTPUT_DIR, exist_ok=True)


def load_data(base_path):
    pos_train = np.load(os.path.join(base_path, "pos_real_train_rag.npy"))
    neg_train = np.load(os.path.join(base_path, "neg_real_train_rag.npy"))
    pos_test  = np.load(os.path.join(base_path, "pos_real_test_rag.npy"))
    neg_test  = np.load(os.path.join(base_path, "neg_real_test_rag.npy"))
...
def main():
    ...
    all_results = []
    per_seed_csv = os.path.join(OUTPUT_DIR, "per_seed_results.csv")
    ...
    for seed in SEEDS:
        ...
        weights_path = os.path.join(OUTPUT_DIR, f"weights_seed{seed}.weights.h5")
    ...
    summary_csv = os.path.join(OUTPUT_DIR, "summary_mean_std.csv")
